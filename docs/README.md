...
- `operations/UPGRADE-9.4.4.md`: aggiornamento e collaudo della release corrente.
- `operations/RAPPORTO-VERIFICHE-OFFLINE-9.4.4.md`: evidenze automatiche e limiti delle prove locali.
