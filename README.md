...
Versione corrente: **9.4.8**. Requisiti minimi: WordPress 6.6, PHP 8.2 e HTTPS. Il frontend usa React e TypeScript; il backend usa API REST WordPress e tabelle dedicate.
...
- `releases/`: ZIP installabili versionati e checksum SHA-256; la 9.4.8 è la release corrente.

## Installazione

Usare `releases/gestione-scarto-librario-9.4.8.zip` da **Plugin > Aggiungi plugin > Carica plugin**. Prima dell'aggiornamento eseguire un backup e leggere `docs/operations/UPGRADE-9.4.8.md`. Verificare sempre il checksum pubblicato.
